...
void MainMenuView::pumpStatus() {
    ...
    if (CurrentState::isCentralHeatingPumpOn) {
...
void MainMenuView::show() {
    ...
    if (Knob::get()->getPosition() == 0) {
        ...
        txt.concat(CurrentState::fumesTemperature);
        txt.concat((char)0xf8);
        txt.concat('C');
        Lcd::get()->screen()->print(txt);
        ...
        Lcd::get()->screen()->drawXBitmap(48, 25, ogien_bits, ogien_width, ogien_height, SSD1306_WHITE);
    } else if (Knob::get()->getPosition() == 2) {
        Lcd::get()->screen()->clearDisplay();
        Lcd::get()->screen()->setCursor(1, 5);
        Lcd::get()->screen()->print("Ciepla");
        Lcd::get()->screen()->setCursor(80, 5);
        Lcd::get()->screen()->print("woda");
        Lcd::get()->screen()->drawXBitmap(48, 25, bojler_bits, bojler_width, bojler_height, SSD1306_WHITE);
    } else if (Knob::get()->getPosition() == 3) {
        Lcd::get()->screen()->clearDisplay();
        Lcd::get()->screen()->setCursor(5, 5);
        Lcd::get()->screen()->print("Kaloryfery");
        Lcd::get()->screen()->drawXBitmap(48, 25, kaloryfer_bits, kaloryfer_width, kaloryfer_height, SSD1306_WHITE);
    } else if (Knob::get()->getPosition() == 4) {
        Lcd::get()->screen()->clearDisplay();
        Lcd::get()->screen()->setCursor(5, 5);
        Lcd::get()->screen()->print("Wentylator");
        Lcd::get()->screen()->drawXBitmap(48, 25, wentylator_bits, wentylator_width, wentylator_height, SSD1306_WHITE);
    } else if (Knob::get()->getPosition() == 5) {
        Lcd::get()->screen()->clearDisplay();
        Lcd::get()->screen()->setCursor(10, 5);
        Lcd::get()->screen()->print("Podajnik");
        Lcd::get()->screen()->drawXBitmap(48, 25, podajnik_bits, podajnik_width, podajnik_height, SSD1306_WHITE);
    } else if (Knob::get()->getPosition() == 6) {
        Lcd::get()->screen()->clearDisplay();
        Lcd::get()->screen()->setCursor(35, 5);
        Lcd::get()->screen()->print("We/Wy");
        Lcd::get()->screen()->drawXBitmap(48, 25, io_bits, io_width, io_height, SSD1306_WHITE);
    }
